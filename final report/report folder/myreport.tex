...
\begin{figure}[H]
  ...
  \end{tikzpicture}
  \end{adjustwidth}
  \caption{\label{fig:pipeline-overview}Unified view of the four detection pipelines. Shared preprocessing branches into frozen (Experiment~A, C) and trainable encoders (Experiment~B, D), then reconverges on mean pooling, L2 normalisation, their respective heads, and a common 0.5 sigmoid decision.}
\end{figure}
