...
\begin{enumerate}
  ...
  \item \textbf{Sentence dataset creation} Building a corpus of example sentences illustrating verlan usage in context.
...
With such a sub-word permutation, researchers can not only discuss it within the linguistic realm.
This property also presents a unique opportunity to examine how large language models process non-standard subword permutations.
As Véla noted, verlan remains linguistically ambiguous and socially expressive, characteristics that make it both challenging and intriguing for computational modelling.
