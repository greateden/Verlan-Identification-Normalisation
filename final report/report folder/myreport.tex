...
Verlan, in fact, is a niche thing in slang detection research. Thus, regarding the history of verlan detection, this repord would generalise it as slang detection, and also not limited in French but other Indo-European languages\footnote{For example, English, German and Russian. For more information, please refer to: \url{https://en.wikipedia.org/wiki/Indo-European_languages}}, in order to give the readers a general yet useful background. There will be discussions related to theoratical ways to implement those methods for verlan detection.
