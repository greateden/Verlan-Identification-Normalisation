...
\bibitem{rajabov2025}
R. R. Rajabmurodovich, ``Understanding `verlan' in the French language,'' \textit{Web of Discoveries: Journal of Analysis and Inventions}, vol. 3, no. 2, pp. 76-79, Feb. 2025. [Online]. Available: https://webofjournals.com/index.php/3/article/view/3264
...
\bibitem{rua2005}
P. L. Rúa, ``Shortening devices in text messaging: A multilingual approach,'' \textit{Neuphilologische Mitteilungen}, vol. 106, no. 2, pp. 139-155, 2005. [Online]. Available: http://www.jstor.org/stable/43344127
...
\bibitem{deepl2020}
DeepL, ``How does DeepL work?,'' \textit{DeepL Blog}, Nov. 2021. [Online]. Available: https://www.deepl.com/en/blog/how-does-deepl-work
...
A. Podhorná-Polická, ``RapCor, Francophone rap songs text corpus,'' in \textit{Proc. 14th Workshop Recent Advances in Slavonic NLP (RASLAN 2020)}, Dec. 2020, pp. 95-102. [Online]. Available: http://nlp.fi.muni.cz/raslan/2020/paper6.pdf
...
Z. Pei, Z. Sun, and Y. Xu, ``Slang detection and identification,'' in \textit{Proc. 23rd Conf. Computational Natural Language Learning (CoNLL 2019)}, Nov. 2019, pp. 881-889. [Online]. Available: https://aclanthology.org/K19-1082/
...
Anonymous, ``Slang or not? Exploring NLP techniques for slang detection using the SlangTrack dataset,'' ACL ARR submission, Dec. 2024. [Online]. Available: https://openreview.net/forum?id=bISO3DD8sU

\bibitem{dhuliawala2016slangnet}
S. Dhuliawala, D. Kanojia, and P. Bhattacharyya, ``SlangNet: A WordNet-like resource for slang words,'' in \textit{Proc. 10th Int. Conf. Language Resources and Evaluation (LREC 2016)}, May 2016. [Online]. Available: https://www.cse.iitb.ac.in/~pb/papers/lrec16-slangnet.pdf
...
J. D. Kaye, ``De la syllabicité,'' \textit{www.academia.edu}, Dec. 2015, [Online]. Available: https://www.academia.edu/19601005/De\_la\_syllabicit\%C3\%A9

\bibitem{russell1918soundex}
R. C. Russell and M. K. Odell, ``Soundex system of indexing names,'' U.S. Patent 1,261,167, Apr. 2, 1918, [Online]. Available: https://patentimages.storage.googleapis.com/31/35/a1/f697a3ab85ced6/US1261167.pdf

\bibitem{levenshtein1966}
V. I. Levenshtein, ``Binary codes capable of correcting deletions, insertions, and reversals,'' \textit{Soviet Physics Doklady}, vol. 10, no. 8, pp. 707-710, Jan. 1966, [Online]. Available: https://ci.nii.ac.jp/naid/10020212767

\bibitem{philips1990metaphone}
L. Philips, ``Hanging on the Metaphone,'' \textit{Computer Language}, 1990. [Online]. Available: https://aspell.net/metaphone/

\bibitem{philips2000doublemetaphone}
L. Philips, ``The Double Metaphone search algorithm,'' \textit{C/C++ Users Journal}, Jun. 2000. [Online]. Available: https://xlinux.nist.gov/dads/HTML/doubleMetaphone.html
...
A. Aw, M. Zhang, J. Xiao, and J. Su, ``A phrase-based statistical model for SMS text normalization,'' in \textit{Proc. COLING/ACL 2006 Main Conf. Poster Sessions}, Jul. 2006, pp. 33-40. [Online]. Available: https://aclanthology.org/P06-2005/

\bibitem{beaufort2010hybrid}
R. Beaufort, S. Roekhaut, L.-A. Cougnon, and C. Fairon, ``A hybrid rule/model-based finite-state framework for normalizing SMS messages,'' in \textit{Proc. 48th Annu. Meeting Assoc. Comput. Linguistics (ACL 2010)}, Jul. 2010. [Online]. Available: https://aclanthology.org/P10-1079.pdf

\bibitem{han2011lexical}
B. Han and T. Baldwin, ``Lexical normalisation of short text messages: Makn sens a \#twitter,'' in \textit{Proc. 49th Annu. Meeting Assoc. Comput. Linguistics: Human Language Technologies (ACL-HLT 2011)}, Jun. 2011, pp. 368-378. [Online]. Available: https://aclanthology.org/P11-1038/
...
S. R. Wilson, W. Magdy, B. McGillivray, K. Garimella, and G. Tyson, ``Urban Dictionary embeddings for slang NLP applications,'' in \textit{Proc. 12th Conf. Language Resources and Evaluation (LREC 2020)}, May 2020, pp. 4764-4773. [Online]. Available: https://aclanthology.org/2020.lrec-1.586/
...
L. van der Maaten and G. Hinton, ``Visualizing data using t-SNE,'' \textit{Journal of Machine Learning Research}, vol. 9, no. 86, pp. 2579-2605, Nov. 2008, [Online]. Available: http://isplab.tudelft.nl/sites/default/files/vandermaaten08a.pdf
