...
% The project releases a single dataset comprising a 1,086-entry Verlan--standard French lexicon and a sentence-level, balanced annotated corpus of 5,684 examples, as well as three specially constructed test sets (Daily Verlan, Invented Verlan, Slang).
