...
def main() -> None:
    ...
    slang_eval = evaluate(head, enc, slang_loader)
    ...
    meta = {
        ...
        "artifacts": {
            "head_checkpoint": str(ckpt_path.relative_to(PROJECT_ROOT) if str(ckpt_path).startswith(str(PROJECT_ROOT)) else ckpt_path),
